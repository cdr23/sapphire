...
sleep 1
wget https://raw.githubusercontent.com/scscp/xraylite/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
...
echo -e "\e[1;32m══════════════════ Autoscript By cdr23 ══════════════════\e[0m" | tee -a log-install.txt
sleep 7
clear
echo ""
echo -e "    \e[1;32m.------------------------------------------.\e[0m"
echo -e "    \e[1;32m|     SUCCESFULLY INSTALLED THE SCRIPT     |\e[0m"
echo -e "    \e[1;32m|             PREMIUM BY cdr23            |\e[0m"
echo -e "    \e[1;32m'------------------------------------------'\e[0m"
echo ""
